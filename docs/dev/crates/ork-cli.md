...
|------|---------|---------|----------|
| [.dockerignore](../../../crates/ork-cli/.dockerignore) | Excludes local artifacts from the Docker build context. | 2026-01-30 | 52ea51c |
| [Cargo.toml](../../../crates/ork-cli/Cargo.toml) | Crate manifest and feature wiring for the CLI binaries. | 2026-01-30 | 43c7679 |
| [Dockerfile](../../../crates/ork-cli/Dockerfile) | Container image build for running the ork CLI/scheduler. | 2026-01-30 | 2ca2a5e |
| [README.md](../../../crates/ork-cli/README.md) | Usage and development notes specific to the CLI. | 2026-01-30 | 908b163 |
| [docker-compose.yml](../../../crates/ork-cli/docker-compose.yml) | Local Postgres service definition for development and tests. | 2026-01-30 | 1618f66 |
...
| [schema.sql](../../../crates/ork-cli/schema.sql) | Generated schema snapshot after applying all migrations. | 2026-01-31 | 91d6eaf |
...
| [src/bin/perf-test.rs](../../../crates/ork-cli/src/bin/perf-test.rs) | Performance test binary used by `just perf-*` workflows. | 2026-01-30 | b32d163 |
| [src/main.rs](../../../crates/ork-cli/src/main.rs) | CLI entry point that parses commands, initializes storage, and starts the scheduler. | 2026-01-30 | 757bcb8 |
...
- Still depends on `ork-runner` for legacy paths.
