...
|------|---------|---------|----------|
| [Cargo.toml](../../../crates/ork-state/Cargo.toml) | Crate manifest and storage backend feature flags. | 2026-02-08 | 3b9c227 |
...
| [migrations/012_add_deferred_jobs.sql](../../../crates/ork-state/migrations/012_add_deferred_jobs.sql) | Adds deferred job tracking table and indexes for triggerer polling. | 2026-02-07 | f118383 |
...
| [migrations_sqlite/007_add_deferred_jobs.sql](../../../crates/ork-state/migrations_sqlite/007_add_deferred_jobs.sql) | Adds deferred job tracking table and indexes for SQLite mode. | 2026-02-07 | 323cf19 |
| [src/file.rs](../../../crates/ork-state/src/file.rs) | File-backed `StateStore` implementation for legacy flows. | 2026-02-07 | 8f348a7 |
| [src/file_database.rs](../../../crates/ork-state/src/file_database.rs) | `FileDatabase` backed by JSON files for local/dev use. | 2026-02-08 | 150a42a |
...
| [src/file_database/deferred_jobs.rs](../../../crates/ork-state/src/file_database/deferred_jobs.rs) | File-backed deferred job CRUD and completion tracking. | 2026-02-08 | f9d8070 |
| [src/file_database/runs.rs](../../../crates/ork-state/src/file_database/runs.rs) | File-backed run CRUD and status updates. | 2026-02-08 | 37e7ac0 |
| [src/file_database/tasks.rs](../../../crates/ork-state/src/file_database/tasks.rs) | File-backed task CRUD, status updates, and logs. | 2026-02-08 | 1a28afe |
...
| [src/memory.rs](../../../crates/ork-state/src/memory.rs) | In-memory `StateStore` implementation for legacy flows. | 2026-02-07 | 6058976 |
| [src/object_store.rs](../../../crates/ork-state/src/object_store.rs) | Object store trait and local implementation for specs/status/output. | 2026-02-08 | 54b906a |
| [src/postgres.rs](../../../crates/ork-state/src/postgres.rs) | `PostgresDatabase` implementation with SQLx queries and batch operations. | 2026-02-08 | 2b4cde1 |
| [src/postgres/core.rs](../../../crates/ork-state/src/postgres/core.rs) | Postgres connection setup and migrations. | 2026-02-06 | 5314183 |
| [src/postgres/deferred_jobs.rs](../../../crates/ork-state/src/postgres/deferred_jobs.rs) | Postgres deferred job queries and status updates. | 2026-02-08 | dd28621 |
| [src/postgres/runs.rs](../../../crates/ork-state/src/postgres/runs.rs) | Postgres run queries and status updates. | 2026-02-08 | bf4ec11 |
| [src/postgres/tasks.rs](../../../crates/ork-state/src/postgres/tasks.rs) | Postgres task queries, updates, and dispatch filtering. | 2026-02-08 | 434f56c |
...
| [src/sqlite.rs](../../../crates/ork-state/src/sqlite.rs) | `SqliteDatabase` implementation for standalone local runs. | 2026-02-08 | a4cddbc |
| [src/sqlite/core.rs](../../../crates/ork-state/src/sqlite/core.rs) | SQLite connection setup and row mapping. | 2026-02-08 | 88a9e56 |
| [src/sqlite/deferred_jobs.rs](../../../crates/ork-state/src/sqlite/deferred_jobs.rs) | SQLite deferred job queries and status updates. | 2026-02-08 | b459f2c |
| [src/sqlite/runs.rs](../../../crates/ork-state/src/sqlite/runs.rs) | SQLite run queries and status updates. | 2026-02-08 | f93fe7c |
| [src/sqlite/tasks.rs](../../../crates/ork-state/src/sqlite/tasks.rs) | SQLite task queries, updates, and dispatch filtering. | 2026-02-08 | c159589 |
...
| [tests/postgres_backend_edge_test.rs](../../../crates/ork-state/tests/postgres_backend_edge_test.rs) | Additional Postgres integration edge-case coverage for scheduling, retries, and deferred job branches. | 2026-02-08 | 1eaa617 |
| [tests/postgres_backend_test.rs](../../../crates/ork-state/tests/postgres_backend_test.rs) | Postgres integration contract tests for workflow/run/task/deferred-job backend behavior. | 2026-02-08 | eb13de7 |
| [tests/sqlite_backend_edge_test.rs](../../../crates/ork-state/tests/sqlite_backend_edge_test.rs) | SQLite integration edge-case coverage for pending-task accessors, retry metadata, outputs, and deferred-job cancellation. | 2026-02-08 | b71f474 |
