...
- Postgres schema and migrations live in [crates/ork-cli/](../../../crates/ork-cli/).
...
| [src/file_database.rs](../../../crates/ork-state/src/file_database.rs) | `FileDatabase` backed by JSON files for local/dev use. | 2026-01-30 | d2cdf69 |
...
| [src/postgres.rs](../../../crates/ork-state/src/postgres.rs) | `PostgresDatabase` implementation with SQLx queries and batch operations. | 2026-01-30 | 6860a71 |
